...
async def incoming_start_message_f(bot, update):
    ...
    if UPDATES_CHANNEL is not None:
        ...
        try:
            ...
            await message.reply_text(
                text="Something went Wrong. Contact my [Support Group](https://t.me/jacks_official).",
                parse_mode="markdown",
                disable_web_page_preview=True
            )
            return
    await bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('Updates Channel', url='https://t.me/arya_bots')
                ],
                [
                    InlineKeyboardButton('Support Group', url='https://t.me/jacks_official')
                ]
            ]
        ),
